...
import static methodFR.AFRFace.extractFRFeature;
...
public class AFDFace {
     ...
     * @return
     */
    public static  FaceInfo[] doDetection(String inPath){
        System.out.println("#####################################################");
       ...
       /* if (bUseYUVFile) {*/
        ...
        //.......
        //.......    这行由自己添加,目的为提取特征值对象AFR_FSDK_FACEMODEL
       // AFR_FSDK_FACEMODEL faceFeatureA = extractFRFeature(hFDEngine, inputImg, faceInfos[0]);

        //........这行自己添加 目的为从AFR_FSDK_FACEMODEL对象中取出特征值
       // byte[] bytes = faceFeatureA.toByteArray();
            //例如:
        ...
        //....这行自己添加 目的是将特征反序列化为AFR_FSDK_FACEMODEL 对象
       // AFR_FSDK_FACEMODEL afr_fsdk_facemodel = AFR_FSDK_FACEMODEL.fromByteArray(bytes);
